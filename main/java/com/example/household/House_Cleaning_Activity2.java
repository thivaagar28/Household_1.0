...
public class House_Cleaning_Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_house_cleaning2);


        ServiceRef = FirebaseDatabase.getInstance().getReference().child("Service_Provider").child("Cleaner");
                    ...
                    public Service_View onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        ...
                        booking.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                Intent intent = new Intent(House_Cleaning_Activity2.this,ConfirmBookingActivity.class);
