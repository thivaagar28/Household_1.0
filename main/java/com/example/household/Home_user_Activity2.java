...
public class Electrical_Service_Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ServiceRef = FirebaseDatabase.getInstance().getReference().child("Service_Provider").child("Electrician");
                    ...
                    public Service_View onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        ...
                        booking.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v)
                            {
                                ...
                                Intent intent = new Intent(Electrical_Service_Activity2.this,ConfirmBookingActivity.class);
